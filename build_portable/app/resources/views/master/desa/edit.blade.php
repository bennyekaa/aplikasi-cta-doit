                            ...
                            <form action="{{ url('master/desa/proses') }}" method="post">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="id_kecamatan" required>
                                                ...
                                                @foreach($kecamatan as $kec)
                                                    <option value="{{ $kec->id_kecamatan }}" {{ $desa->id_kecamatan == $kec->id_kecamatan ? 'selected' : '' }}>{{ $kec->nama_kecamatan }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="latitude" value="{{ $desa->latitude }}" placeholder="Contoh: -7.7956">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Longitude <small class="text-muted">(Opsional)</small></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="longitude" value="{{ $desa->longitude }}" placeholder="Contoh: 112.8252">
                                        </div>
                                    </div>
                                </div>
